...
const getBooleanEnvironmentValue = (name: string, fallback: boolean) => {
...
export const config: {
  ...
  memedropTrustProxy: getBooleanEnvironmentValue('MEMEDROP_TRUST_PROXY', false),
